...
public class Program100Ti
{
    ...
    public ListNode SortList(ListNode head)
    {
        ...
        ListNode l = head;
        ListNode r = CutListNodes(l);
        ListNode sortedL = SortList(l);
        ListNode sortedR = SortList(r);
        return MergeListNodes(sortedL, sortedR);

        ListNode CutListNodes(ListNode left){
        ...
        ListNode MergeListNodes(ListNode node1, ListNode node2){
            // 小技巧：虚拟头节点
...
{
    private Dictionary<int, int> _sto = new Dictionary<int, int>();
    ...
    {
        return _sto.GetValueOrDefault(key, -1);
    }
